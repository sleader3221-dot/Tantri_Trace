  ...
  head: () => ({
    meta: [
      ...
      { title: "TantriTrace - Handloom Authenticity System" },
      {
        name: "description",
        content:
          "Working handloom authenticity app with product registration, SHA-256 verification, tamper-evident ledger, weaver profiles, scan analytics, and exportable records.",
      },
